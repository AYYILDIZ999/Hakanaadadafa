...
if (!cezalımı) return;
if (cezalımı == "cezali") {
member.roles.add("785629452460621868")
member.roles.remove('785629452486836249');

 setTimeout(function(){
    // msg.channel.send(`<@${user.id}> Muten açıldı.`)
db.delete(`cezali_${member.guild.id + member.id}`)
    member.send(`<@${member.id}> Cezan açıldı.`)
    member.roles.remove('785629452460621868');
  }, ms(sürejail));
}
})
...
if (!mutelimi) return;
if (mutelimi == "muteli") {
member.roles.add("785629452460621869")
member.roles.remove('785629452486836249');
...
db.delete(`muteli_${member.guild.id + member.id}`)
    ...
    member.roles.remove('785629452460621869');
  }, ms(süre));
}
})
